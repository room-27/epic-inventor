...
public class VineThorn extends Monster {

    private static final long serialVersionUID = 10000L;
    private String finalImageName = "";

    public VineThorn(MonsterManager mm, Registry rg, String im, String st, int x, int y, int minDist, int maxDist) {
        super(mm, rg, im, st, x, y, minDist, maxDist, false);

        name = "VineThorn";
        displayName = "Vine Thorn";

        hideDisplayName = true;
        finalImageName = "VineThorn" + Rand.getRange(1, 2);
